...
let dogName = "waffles";
console.log("Type: " + typeof dogName + " Value:" + dogName);

// number	- Numbers with or without decimal places
let quantity = 100;
let price = 8.5;
console.log("Type: " + typeof quantity + " Value:" + quantity);
console.log("Type: " + typeof price + " Value:" + price);

// boolean - true or false
let isStudent = true;
console.log("Type: " + typeof isStudent + " Value:" + isStudent);
...
console.log("Type: " + typeof courses + " Value:" + courses);
...
console.log("Type: " + typeof petName + " Value:" + petName);
